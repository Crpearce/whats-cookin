...
describe('Pantry', () => {
  ...
  it('should tell the user if they can cook the recipe', () => {
    expect(pantry.canCookRecipe()).to.equal(`sorry you are missing ingredients to cook this recipe`)
  });

  it('should tell the user how many ingredients are missing to cook the recipe', () => {
    expect(pantry.checkForIngredients(595736, recipeData)).to.be.an('string')
  });
